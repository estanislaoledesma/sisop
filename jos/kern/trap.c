...
trap_init_percpu(void)
{
	...
	// That selector consists of a 2-bit Requested Privilege Level (RPL), a 1-bit Table Indicator (TI),
	// and a 13-bit index. When attempting address translation of a given logical address, the processor
	// reads the 64-bit segment descriptor structure from either the Global Descriptor Table when TI=0 or
